...
class EvidenceContractTests(unittest.TestCase):
    ...
    def test_tracked_real_app_proof_discovery_cannot_omit_uf09_or_parse_other_records(self) -> None:
        tracked = {
            ...
            "evidence/issue-13-xcode-cloud-run8-focused-green-proof.json",
