...
| D-005 | Speech runtime | Open | Compare Apple Speech, WhisperKit, FluidAudio/Parakeet | Phase 0 benchmark |
| D-006 | Local guidance runtime | Open | Adapter boundary; prove best available local route | Phase 0 context/guidance probe |
| D-007 | Distribution | Recommended | Developer ID notarized direct DMG | Owner chooses Mac App Store or dual channel |
| D-008 | Product name and visual identity | Deferred | Neutral codename and original placeholder assets | Before Phase 4 packaging |
